CLASS zcl_20_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
    TYPES tt_addresses TYPE SORTED TABLE OF /lrn/s_address " struct
...
CLASS ZCL_20_TABLE_TYPE IMPLEMENTATION.
...
* Task 1
**********************************************************************
    DATA addresses TYPE Z20Tabletype.
